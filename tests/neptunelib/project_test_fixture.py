...
from tests.neptunelib.api_objects_factory import a_group_leaderboard_entry_dto, an_experiment_leaderboard_entry_dto
...
some_exp_entry_row = {
    ...
    'git_hash': some_exp_entry_dto.gitHash,
...
some_grp_entry_row = {
    ...
    'git_hash': some_grp_entry_dto.gitHash,
