...
from neptunelib.oauth import NeptuneAuth, NeptuneAuthenticator, _no_token_updater
from tests.neptunelib.http_objects_factory import a_request
from tests.neptunelib.oauth_objects_factory import SECRET, a_refresh_token, an_access_token
...
class TestNeptuneAuthenticator(unittest.TestCase):
    ...
    @patch('neptunelib.oauth.OAuth2Session')
    @patch('neptunelib.oauth.time')
