...
class Credentials(object):
    ...
    Examples:
        ...
        Alternatively you can create an environmental variable by running `export NEPTUNE_API_TOKEN=YOUR_API_TOKEN` which will allow
        you to use the `.from_env()` method.
